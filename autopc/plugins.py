...
class PluginsManager:
    ...
    def load_plugins(self):
        ...
        from autopc.api.event import register_all_plugins_controls
        from autopc.api.sender import register_autopc_class

        register_autopc_class(self.autopc)
        register_all_plugins_controls(self.autopc)
